...
urlpatterns = [
    ...
    re_path(r'^wordcloud/(?P<word_hash>[a-f0-9]{40,64})?$', wordcloud_view, name='wordcloud'),
    re_path(r'^wordcloud/(?P<width>[1-9][0-9]{2,3})x(?P<height>[1-9][0-9]{2,3})/(?P<word_hash>[a-f0-9]{40,64})?$', wordcloud_view,
        name='wordcloud'),
